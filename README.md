...
* Posts
  * Weakly and daily articles
* Categories
  * Posts are organized using categories (broad topics) to help users navigate content. 
* Search Functionality
  * A search bar lets users find specific posts by keywords, improving accessibility. 
* Responsive Design
  * The site adapts to different devices (mobile, tablet, desktop) for a consistent user experience

## Installation
```bash
# Clone the repository
git clone https://github.com/hasen38/DevComunity.git
